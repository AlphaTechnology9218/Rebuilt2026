...
public class AbsoluteDrive extends Command
{
  ...
  public void execute()
  {
    ...
    ChassisSpeeds desiredSpeeds = swerve.getTargetSpeeds(vX.getAsDouble()*1.5, vY.getAsDouble()*1.5,
                                                         headingHorizontal.getAsDouble()*1.5,
                                                         headingVertical.getAsDouble()*1.5);
    ...
    translation = SwerveMath.limitVelocity(translation, swerve.getFieldVelocity(), swerve.getPose(),
                                           Constants.SwerveConstants.LOOP_TIME,
                                            Constants.SwerveConstants.ROBOT_MASS,
